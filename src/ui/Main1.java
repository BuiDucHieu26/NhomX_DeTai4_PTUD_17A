...
//		datPhong_DAO = new DonDatPhong_DAO();
		...
		btnBack.setIcon(Utils.getImageIcon("back1.png"));
...
//		End Default Layout
		...
		NhanVien nhanVien = nhanVien_DAO.getNhanVienTheoMa("NV001");
		...
		menu.addEvent(new EventMenuSelected() {
			...
			public void menuSelected(int index, int indexSubMenu) {
				...
				case Utils.quanLyNhanVienMenuItem:
					...
					//pnl = new QuanLiNhanVien_GUI(_this);
					break;
